...
S1 = dict(
    ...
    dict(id="cover", kind="cover",
         ...
         video=dict(src="assets/video/skynet-overview-general-atlas.mp4",
                    poster="assets/video/skynet-overview-general-poster.webp",
                    captions="assets/video/skynet-overview-general-en.vtt",
                    walkthrough=dict(src="assets/video/skynet-full-walkthrough-atlas.mp4",
                                     poster="assets/video/skynet-full-walkthrough-atlas-poster.webp",
