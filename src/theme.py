...
details.phase-acc > summary{list-style:none;cursor:pointer;display:grid;grid-template-columns:auto 1fr auto auto;gap:14px;align-items:baseline;padding:1rem 0}
...
details.phase-acc > summary h3{font-size:1.05rem}
details.phase-acc > summary .who{font-size:var(--fs-cap);color:var(--ink-3);text-align:right}
...
@media (max-width:640px){details.phase-acc > summary{grid-template-columns:auto 1fr auto}details.phase-acc > summary .who{display:none}}
